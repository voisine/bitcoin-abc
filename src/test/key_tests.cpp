...
static const CBitcoinAddress addr1("CfijQPpGx8Y1wXCezKDVtiVSPrYrzs64mx");
static const CBitcoinAddress addr2("CWYreGRKEf45tmDJru2G9zG5fPSN8srZDx");
static const CBitcoinAddress addr1C("CeGCRrDwqS9rZLCKzGmys6FLUede3pJ3hX");
static const CBitcoinAddress addr2C("CTtcbLKQtFW3tR4x2ADdqrbiJVfZQyBC5X");

static const std::string strAddressBad("CYx2uePwFLYVqrxzRqz6ceWGPK5PjawWZu");
